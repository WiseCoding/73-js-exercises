  ...
  Object.entries(exos).forEach(([exo, [title, description]], j) => {
    ...
    fs.writeFileSync(
      ...
      [
        ...
        ` * becode/javascript`,
        ` *`,
        ` * ${exodirname.replace('.', '')}/index.html - ${i + 1}.${j + 1}: ${title}`,
        ` *`,
        ...
        `  <head>`,
        `    <meta charset="UTF-8" />`,
        `    <title>BeCode/JavaScript - ${i + 1}.${j + 1}: ${title}</title>`,
        ``,
        `    <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet" />`,
        `    <link rel="stylesheet" href="../../00-shared/css/normalize.css" />`,
        `    <link rel="stylesheet" href="../../00-shared/css/styles.css" />`,
        `  </head>`,
        `  <body>`,
        `    <div class="container">`,
        `      <header>`,
    ...
    fs.writeFileSync(
      ...
      [
        `/* becode/javascript`,
        ` *`,
        ` * ${exodirname.replace('.', '')}/script.js - ${i + 1}.${j + 1}: ${title}`,
        ` *`,
        ` * coded by leny@BeCode`,
        ` * started at 26/10/2018`,
        ` */`,
